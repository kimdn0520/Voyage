...
EVENT_ADULTHOOD_NOTURTLE::EVENT_ADULTHOOD_NOTURTLE(EventMachine* ref)
	: ref(ref)
{

}

EVENT_ADULTHOOD_NOTURTLE::~EVENT_ADULTHOOD_NOTURTLE()
{}

void EVENT_ADULTHOOD_NOTURTLE::Start()
{
...
int EVENT_ADULTHOOD_NOTURTLE::Update()
{
...
void EVENT_ADULTHOOD_NOTURTLE::End()
{
...
/// 거북이와 트리거작용시 나오게 하자
/// </summary>
void EVENT_ADULTHOOD_NOTURTLE::SellDreamScript_1()
{
	if (_isSellDreamTalk_1)
	{
		...
		if (ref->_mainTalkPanel->GetScript<AdulthoodText>()->Text20Size() == _nowText)
		{
			...
			ref->SetEventAdultNextText(19);
		}
	}
}

void EVENT_ADULTHOOD_NOTURTLE::SellDreamScript_2()
{
	if (_isSellDreamTalk_2)
	{
		...
		if (ref->_mainTalkPanel->GetScript<AdulthoodText>()->Text21Size() == _nowText)
		{
			...
			ref->SetEventAdultNextText(20);
		}
	}
}

void EVENT_ADULTHOOD_NOTURTLE::SellDreamScript_3()
{
	if (_isSellDreamTalk_3)
	{
		...
		if (ref->_mainTalkPanel->GetScript<AdulthoodText>()->Text22Size() == _nowText)
		{
...
void EVENT_ADULTHOOD_NOTURTLE::SellDreamScriptCheck_1()
{
	int talker = ref->_mainTalkPanel->GetScript<AdulthoodText>()->ReturnTalker20(_nowText);
	ref->SetPanelImage(talker);
}

void EVENT_ADULTHOOD_NOTURTLE::SellDreamScriptCheck_2()
{
	int talker = ref->_mainTalkPanel->GetScript<AdulthoodText>()->ReturnTalker21(_nowText);
	ref->SetPanelImage(talker);
}

void EVENT_ADULTHOOD_NOTURTLE::SellDreamScriptCheck_3()
{
	int talker = ref->_mainTalkPanel->GetScript<AdulthoodText>()->ReturnTalker22(_nowText);
	ref->SetPanelImage(talker);
}

void EVENT_ADULTHOOD_NOTURTLE::CameraMove()
{
...
void EVENT_ADULTHOOD_NOTURTLE::CameraStarMove()
{
